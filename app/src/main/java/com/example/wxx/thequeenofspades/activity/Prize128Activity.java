...
public class Prize128Activity extends AppCompatActivity {
    ...
    EvaporateTextView mTvFade4;
    @BindView(R.id.tvFade5)
    EvaporateTextView mTvFade5;
    @BindView(R.id.tvFade6)
    EvaporateTextView mTvFade6;
        ...
        mSubscribe = Observable.interval(0, 1, TimeUnit.MILLISECONDS).observeOn(AndroidSchedulers.mainThread()).subscribe(new Consumer<Long>() {
            ...
            public void accept(@NonNull Long aLong) throws Exception {
                if (aLong > 3000) {
                    ...
                    mTvFade5.setProgress(aLong / 3000f);
                    mTvFade6.setProgress(aLong / 3000f);
                }
            }
        });
